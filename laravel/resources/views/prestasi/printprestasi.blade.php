...
<head>
  ...
  <title> Print - Pondok Pesantren Askhabul Kahfi </title>
...
<div class="wrapper">
  <!-- Main content -->
  <section class="invoice border-success">
    <!-- title row -->
    <div class="row">
      <div class="col-12">
    ...
    <div class="row invoice-info">
      <div class="col-sm-9 invoice-col ">
        ...
        <li class="list-group-item">
          <h4>
            <b>Alamat</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp; <a class="float-center"> {{$siswa->desa}}, {{$siswa->kecamatan}}, {{$siswa->state}}, {{$siswa->country}} </a>
          </h4>
        </li>

        <li class="list-group-item">
          <h4>
            <b>Wali Murid</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp; <a class="float-center"> {{ $siswa->namaayah}} </a>
          </h4>
        </li>
    ...
    <div class="row">
      <div class="col-12">
        <h2 class="page-header">
          <i class="fas fa-globe"></i> Data Prestasi
