<head>
  <title> Pelanggaran Kampus 1 - Pondok Pesantren Askhabul Kahfi</title>
</head>
      ...
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title"> <b> Data Pelanggaran Kampus 1</b> </h3>
          </div>
          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                @foreach(rankingpelanggarankampus1() as $s)
                <tr>
                  <th>{{ $nomer++}}</th>
                  <td>{{ $s->nama}} </td>
                  <td>{{ $s->kampus}} </td>
