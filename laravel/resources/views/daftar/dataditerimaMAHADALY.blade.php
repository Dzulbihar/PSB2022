        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ url('daftar') }}/{{$siswa->id}}/{{('deletedataditerimaMA')}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau di hapus ?')">Delete</a>
                    </td>
                  </tr>
                  @endforeach  
                </tbody>
              ...
              <a href="{{url('daftar/dataditerimaSMP1')}}" class="btn btn-info"> Data diterima <b>SMP 1</b> </a>
              <a href="{{url('daftar/dataditerimaSMP2')}}" class="btn btn-info"> Data diterima <b>SMP 2</b> </a>
              <a href="{{url('daftar/dataditerimaMTs')}}" class="btn btn-info"> Data diterima <b>MTs</b> </a>
              <a href="{{url('daftar/dataditerimaSMK')}}" class="btn btn-info"> Data diterima <b>SMK</b> </a>
              <a href="{{url('daftar/dataditerimaMA')}}" class="btn btn-info"> Data diterima <b>MA</b> </a>
              <a href="{{url('daftar/dataditerimaMAHADALY')}}" class="btn btn-info"> Data diterima <b>Mahad Aly</b> </a>
