...
@endif 
              ...
              <tr>
                ...
                <td> : </td>
                <td>
                  {{Str::upper($siswa->desa) }}, {{Str::upper($siswa->kecamatan) }}, {{Str::upper($siswa->state) }}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td> : </td>
                <td>
                  {{Str::upper($siswa->jenjang) }}, {{Str::upper($siswa->kelas) }}, {{Str::upper($siswa->ruang) }}
                </td>
              </tr>   
              ...
              <tr>
                ...
                <td> : </td>
                <td>
                  {{Str::upper($siswa->kampus) }}, {{Str::upper($siswa->gedung) }}, {{Str::upper($siswa->kamar) }}
                </td>
              </tr> 
            ...
            <div class="panel-body">
              <table width="100%" border="4" cellspacing="2" cellpadding="5">
                ...
                <!-- ambil data di database-->
                  ...
                  <tr>
                    <th>{{ $nomer++}}</th>
                    <td> {{ date('d F Y', strtotime($registrasi->waktu)) }} </td>
