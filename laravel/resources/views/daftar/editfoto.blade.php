		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="card card-primary">
					...
					<!-- form start -->
					<form action="{{ url('daftar') }}/{{$siswa->id}}/{{('updatefoto')}}" method="POST" enctype="multipart/form-data"  >
						{{csrf_field()}}
						<div class="card-body">
					<!-- foto --> 
					...
					<!-- tombol -->    
								<div class="form-group row">                    
									<div class="col-md-12">
										...
										<a href="{{ url('daftar') }}/{{$siswa->id}}/{{('detail')}}" rel="noopener" class="btn btn-primary btn-sm float-right"> Kembali </a>
									</div>
								</div>
					</form>
				</div>
