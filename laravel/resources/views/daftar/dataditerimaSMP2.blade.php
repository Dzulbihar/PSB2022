                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ url('daftar') }}/{{$siswa->id}}/{{('deletedataditerimaSMP2')}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau di hapus ?')">Delete</a>
                    </td>
                  </tr>
                  @endforeach  
                </tbody>
