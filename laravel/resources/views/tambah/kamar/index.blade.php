      ...
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title"> <b> Tambahkan Kamar disini </b> </h3>
          </div>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <th>{{ $nomer++}}</th>
                  <td>{{ $kamar->kec_kab}} </td>
                  <td>{{ $kamar->kec_kode}} </td>
                  <td>
                    <a href="{{ url('kamar') }}/{{$kamar->id}}/{{('editkamar')}}" class="btn btn-warning btn-sm">Edit</a>
                    <a href="{{ url('kamar') }}/{{$kamar->id}}/{{('deletekamar')}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau di hapus ?')">Delete</a>
                  </td>
                </tr>
                @endforeach  
              </tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="{{ url('kamar/createkamar') }}" method="POST" enctype="multipart/form-data" >
            {{csrf_field()}}
            ...
            <div class="form-group row">  
              ...
              <div class="col-md-6">
                <label> Kamar </label>
                <input id="kec_kode" type="text" class="form-control" name="kec_kode" value="{{ old('kec_kode') }}" placeholder="Tambah Kamar">
              </div>
            </div>
