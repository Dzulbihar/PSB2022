<head>
	<title> Laporan Pendaftaran santri baru Alumni ke Mahad Aly </title>
	<!-- DataTables -->
...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-8">
				<h1> <b>Alumni Aska ke Mahad Aly</b> </h1>
			</div>
			<div class="col-sm-4">
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title"> Pendaftaran santri baru Alumni ke Mahad Aly </h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
