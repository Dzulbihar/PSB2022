...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1> Data Santri Kampus 1 </h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{url('/home')}}">Home</a></li>
          <li class="breadcrumb-item active"> Ummar bin Khattab </li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"> Kamar 2.01 Ummar bin Khattab </h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $siswa->nohp}} </td>
                  <td>
                    <a href="{{ url('umar201') }}/{{$siswa->id}}/{{('detail201')}}" class="btn btn-success btn-sm">Detail</a>
                    <a href="{{ url('umar201') }}/{{$siswa->id}}/{{('edit201')}}" class="btn btn-warning btn-sm">Edit</a>
                    <a href="{{ url('umar201') }}/{{$siswa->id}}/{{('delete201')}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau di hapus ?')">Delete</a>
                  </td>
                </tr>
                @endforeach  
              </tbody>
...
<!-- Formulir ______________________________________________________________________________________________ -->
        <div class="modal-body">
          ...
          <form action="{{url('umar201/create201')}}" method="POST" enctype="multipart/form-data" >
            {{csrf_field()}}
